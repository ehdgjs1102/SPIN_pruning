...
DB_ROOT = '/data'
LSP_ROOT = join(DB_ROOT, 'lsp')
LSP_ORIGINAL_ROOT = join(DB_ROOT, 'lsp_ori')
LSPET_ROOT = join(DB_ROOT, 'hr-lspet')
MPII_ROOT = join(DB_ROOT, 'mpii_add')
COCO_ROOT = join(DB_ROOT, 'coco_add')
MPI_INF_3DHP_ROOT = join(DB_ROOT, 'mpiinf_add')
PW3D_ROOT = join(DB_ROOT, '3dpw')
UPI_S1H_ROOT = join(DB_ROOT, 'upi-s1h')
H36M_ROOT = join(DB_ROOT, 'human36_add')
...
STATIC_FITS_DIR2 = '/home/urp10/SPIN/data/static_fits'
STATIC_FITS_DIR = '/home/urp10/SPIN/data/spin_fits'
SMPL_MEAN_PARAMS = 'data/smpl_mean_params.npz'
SMPL_MODEL_DIR = '/data/smpl_models/smpl'
