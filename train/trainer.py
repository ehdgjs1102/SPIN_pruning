...
class Trainer(BaseTrainer):
    ...
    def init_fn(self):
        ...
        # self.model = comp_resnet50(config.SMPL_MEAN_PARAMS, compress_rate).to(self.device)


        compress_rate = [ [0.35], [0.35]*6, [0.35]*12, [0.35]*24, [0.35]*16 ]
        self.model = final_model(config.SMPL_MEAN_PARAMS, compress_rate).to(self.device)
    ...
    def train_step(self, input_batch):
        ...
        """
        Here are main losses from HMR.
        You can add extra losses using your idea.
