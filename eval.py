...
parser.add_argument('--checkpoint', default='/home/urp10/SPIN/logs/resnet_0.2_with_spinfits/checkpoints/2021_08_30-14_15_22.pt', help='Path to network checkpoint')
...
parser.add_argument('--num_workers', default=32, type=int, help='Number of processes for data loading')
...
def run_evaluation(model, dataset_name, dataset, result_file,
    ...
    data_length = len(data_loader) * batch_size
    ...
    print('number of images : ' + str(data_length))
    print('time per image : ', total_time / data_length )
...
if __name__ == '__main__':
    ...
    # model = my_model(config.SMPL_MEAN_PARAMS)
