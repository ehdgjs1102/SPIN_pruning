...
"""
from models import my_model, densenet121, comp_resnet50, comp_dense, final_model, SMPL
import torch
...
if __name__ == '__main__':
    ...
    for model in models : 
        ...
        cv2.imwrite(outfile + f'_shape{i}.png', 255 * img_shape[:,:,::-1])
        cv2.imwrite(outfile + f'_shape_side{i}.png', 255 * img_shape_side[:,:,::-1])
        i = i+1
